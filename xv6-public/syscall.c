...
// Add forward declarations of the kernel-side implementations
extern int thread_create_impl(uint func, uint arg, uint u_tidptr);
extern void thread_exit_impl(void);
extern int thread_join_impl(int tid);
